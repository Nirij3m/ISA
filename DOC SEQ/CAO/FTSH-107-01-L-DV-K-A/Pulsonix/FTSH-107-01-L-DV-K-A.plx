...
//1626609/1582353/2.50/14/2/Connector
...
(library Library_1
	...
	(patternDef "FTSH-107-XX-YYY-DV-K-A" (originalName "FTSH-107-XX-YYY-DV-K-A")
		(multiLayer
		...
		(layerContents (layerNumRef 18)
			(arc (pt -3.835, -3.785) (radius 0.05) (startAngle 0.0) (sweepAngle 0.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -3.835, -3.785) (radius 0.05) (startAngle 180.0) (sweepAngle 180.0) (width 0.2))
		)
	...
	(symbolDef "FTSH-107-01-L-DV-K-A" (originalName "FTSH-107-01-L-DV-K-A")
	...
	(compDef "FTSH-107-01-L-DV-K-A" (originalName "FTSH-107-01-L-DV-K-A") (compHeader (numPins 14) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FTSH-107-01-L-DV-K-A"))
		(attachedPattern (patternNum 1) (patternName "FTSH-107-XX-YYY-DV-K-A")
			(numPads 14)
			(padPinMap
		...
		(attr "Mouser Part Number" "200-FTSH10701LDVKA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Samtec/FTSH-107-01-L-DV-K-A?qs=PB6%2FjmICvI3xEHFou4PhNg%3D%3D")
		(attr "Manufacturer_Name" "SAMTEC")
		(attr "Manufacturer_Part_Number" "FTSH-107-01-L-DV-K-A")
		(attr "Description" "14 position, High Reliability Header Strips, 0.050&quot; pitch, Dual-Row Vertical")
		(attr "<Hyperlink>" "http://suddendocs.samtec.com/prints/ftsh-1xx-xx-xxx-dv-xxx-xxx-mkt.pdf")
		(attr "<STEP Filename>" "FTSH-107-01-L-DV-K-A.stp")
		(attr "<STEP Offsets>" "X=-4.44;Y=-0.23;Z=0.01")
